          ...
          <div className="card md:w-1/2">
            <div className="w-full max-w-lg p-8 space-y-3 rounded-xl ">
              ...
              >
                ...
                <div className="space-y-1 text-xl font-semibold">
                  ...
                  {errors.password?.type === "pattern" && (
                    <p className="text-red-500 text-sm">
                      Password can't have capital letter, numeric and special
                      characters.
                    </p>
                  )}
                </div>
              ...
              <div className="flex items-center pt-4 space-x-1">
                ...
                <p className="px-3 text-lg font-medium ">Or sign up with</p>
                <div className="flex-1 h-px sm:w-16 "></div>
              </div>
              <div className="flex justify-center gap-6">
                <button
                  aria-label="Log in with Google"
                  className="p-3 rounded-full border-gray-900 border"
                >
                  <svg
